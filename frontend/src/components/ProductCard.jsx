...
const ProductCard = ({ name, info, image }) => {
  return (
    <div className="w-[250px] h-[370px] bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-xl transition duration-300 flex flex-col p-4 items-center text-center">
